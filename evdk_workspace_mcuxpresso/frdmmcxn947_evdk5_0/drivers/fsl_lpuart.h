...
{
    kLPUART_CONNECTED_EIGHTDataBits = 0x0U, /*!< CONNECTED_EIGHT data bit */
...
typedef struct _lpuart_config
{
    ...
    lpuart_data_bits_t dataBitsCount; /*!< Data bits count, CONNECTED_EIGHT (default), seven */
 ...
 *  lpuartConfig.dataBitsCount = kLPUART_CONNECTED_EIGHTDataBits;
