...
usb_device_endpoint_struct_t g_UsbDeviceVideoControlEndpoints[USB_VIDEO_UVC_CAMERA_CONTROL_ENDPOINT_COUNT] = {
    {
        USB_VIDEO_UVC_CAMERA_CONTROL_ENDPOINT | (USB_IN << USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_SHIFT),
...
usb_device_video_entity_struct_t g_UsbDeviceVideoEntity[] = {
    {
        USB_VIDEO_UVC_CAMERA_VC_INPUT_TERMINAL_ID,   /* The ID of input terminal */
        USB_DESCRIPTOR_SUBTYPE_VIDEO_VC_INPUT_TERMINAL,  /* Entity sub type type is VC input terminal */
        USB_VIDEO_UVC_CAMERA_VC_INPUT_TERMINAL_TYPE, /* VC intput terminal type */
    },
    {
        USB_VIDEO_UVC_CAMERA_VC_OUTPUT_TERMINAL_ID,  /* The ID of output terminal */
        USB_DESCRIPTOR_SUBTYPE_VIDEO_VC_OUTPUT_TERMINAL, /* Entity sub type type is VC output terminal */
        0U,
    },
    {
        USB_VIDEO_UVC_CAMERA_VC_PROCESSING_UNIT_ID,  /* The ID of processing terminal */
...
usb_device_interface_struct_t g_UsbDeviceVideoControlInterface[] = {{
    USB_VIDEO_UVC_CAMERA_CONTROL_INTERFACE_ALTERNATE_0, /* Alternate setting value */
    {
        USB_VIDEO_UVC_CAMERA_CONTROL_ENDPOINT_COUNT, /* control endpoint count */
...
usb_device_endpoint_struct_t g_UsbDeviceVideoStreamEndpoints[USB_VIDEO_UVC_CAMERA_STREAM_ENDPOINT_COUNT] = {
    {
        USB_VIDEO_UVC_CAMERA_STREAM_ENDPOINT_IN | (USB_IN << USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_SHIFT),
...
usb_device_interface_struct_t g_UsbDeviceVideoStreamInterface[] = {
    {
        USB_VIDEO_UVC_CAMERA_STREAM_INTERFACE_ALTERNATE_0, /* Alternate setting value is zero*/
        {
    ...
    {
        USB_VIDEO_UVC_CAMERA_STREAM_INTERFACE_ALTERNATE_1, /* Alternate setting value is one */
        {
            USB_VIDEO_UVC_CAMERA_STREAM_ENDPOINT_COUNT, /* endpoint count is zero for this alternate setting */
...
usb_device_interfaces_struct_t g_UsbDeviceVideoInterfaces[USB_VIDEO_UVC_CAMERA_INTERFACE_COUNT] = {
    {
        ...
        USB_VIDEO_UVC_CAMERA_CONTROL_INTERFACE_INDEX, /* The control interface index */
    ...
    },
    {
        ...
        USB_DEVICE_VIDEO_PC_PROTOCOL_UNDEFINED,          /* Protocol code */
        USB_VIDEO_UVC_CAMERA_STREAM_INTERFACE_INDEX, /* The stream interface index */
...
usb_device_interface_list_t g_UsbDeviceVideoInterfaceList[USB_DEVICE_CONFIGURATION_COUNT] = {
    {
        USB_VIDEO_UVC_CAMERA_INTERFACE_COUNT, /* the interface count */
        g_UsbDeviceVideoInterfaces,               /* the control and stream interfaces pointer */
    },
};

/* The video device all interface list */
usb_device_class_struct_t g_UsbDeviceVideoUVCCameraConfig = {
...
uint8_t g_UsbDeviceConfigurationDescriptor[] = {
    ...
    USB_SHORT_GET_LOW(USB_DESCRIPTOR_LENGTH_CONFIGURE + USB_DESCRIPTOR_LENGTH_INTERFACE_ASSOCIATION +
                      USB_DESCRIPTOR_LENGTH_INTERFACE + USB_VIDEO_UVC_CAMERA_VC_INTERFACE_HEADER_LENGTH +
                      USB_VIDEO_UVC_CAMERA_VC_INPUT_TERMINAL_LENGTH +
                      USB_VIDEO_UVC_CAMERA_VC_OUTPUT_TERMINAL_LENGTH +
                      USB_VIDEO_UVC_CAMERA_VC_PROCESSING_UNIT_LENGTH + USB_DESCRIPTOR_LENGTH_ENDPOINT +
                      USB_DESCRIPTOR_LENGTH_INTERFACE + USB_VIDEO_UVC_CAMERA_VS_INTERFACE_HEADER_LENGTH +
    ...
    USB_VIDEO_UVC_CAMERA_INTERFACE_COUNT,           /* Number of interfaces supported by this configuration */
    USB_VIDEO_UVC_CAMERA_CONFIGURE_INDEX,           /* Value to use as an argument to the
    ...
    USB_VIDEO_UVC_CAMERA_CONTROL_INTERFACE_INDEX, /* Interface number of the first VideoControl
                                                         interface that is associated with this function. */
    USB_VIDEO_UVC_CAMERA_INTERFACE_COUNT,         /* Number of contiguous VideoStreaming interfaces that are
    ...
    USB_VIDEO_UVC_CAMERA_CONTROL_INTERFACE_INDEX, /* Index of control interface */
    USB_VIDEO_UVC_CAMERA_CONTROL_INTERFACE_ALTERNATE_0, /* Index of the interface setting */
    USB_VIDEO_UVC_CAMERA_CONTROL_ENDPOINT_COUNT,  /* One endpoint of control pipe */
    USB_DEVICE_VIDEO_CC_VIDEO,                        /* CC_VIDEO */
    USB_DEVICE_VIDEO_SC_VIDEOCONTROL,                 /* SC_VIDEOCONTROL */
    USB_DEVICE_VIDEO_UVC_CAMERA_PROTOCOL,         /* Protocol */
    0x00U,                                            /* Index of this string descriptor */

    /* Class-Specific VC Interface header Descriptor */
    USB_VIDEO_UVC_CAMERA_VC_INTERFACE_HEADER_LENGTH, /* Size of this descriptor, 12+n */
    ...
    /* bcdUVC */
    USB_SHORT_GET_LOW(USB_VIDEO_UVC_CAMERA_VC_INTERFACE_TOTAL_LENGTH),
    USB_SHORT_GET_HIGH(USB_VIDEO_UVC_CAMERA_VC_INTERFACE_TOTAL_LENGTH),
    /* Total number of bytes returned for the class-specific VideoControl interface descriptor.
       Includes the combined length of this descriptor header and all Unit and Terminal descriptors. */
    USB_LONG_GET_BYTE0(USB_VIDEO_UVC_CAMERA_CLOCK_FREQUENCY),
    USB_LONG_GET_BYTE1(USB_VIDEO_UVC_CAMERA_CLOCK_FREQUENCY),
    USB_LONG_GET_BYTE2(USB_VIDEO_UVC_CAMERA_CLOCK_FREQUENCY),
    USB_LONG_GET_BYTE3(USB_VIDEO_UVC_CAMERA_CLOCK_FREQUENCY),
    /* Use of this field has been deprecated. */
    USB_VIDEO_UVC_CAMERA_STREAM_INTERFACE_COUNT, /* The number of VideoStreaming interfaces in the Video
                                                        Interface Collection to which this VideoControl
                                                        interface belongs: n */
    USB_VIDEO_UVC_CAMERA_STREAM_INTERFACE_INDEX, /* Interface number of the first VideoStreaming
                                                        interface in the Collection */

    /* Input Terminal Descriptor (Camera) */
    USB_VIDEO_UVC_CAMERA_VC_INPUT_TERMINAL_LENGTH, /* Size of this descriptor, 15+n */
    USB_DESCRIPTOR_TYPE_VIDEO_CS_INTERFACE,            /* CS_INTERFACE, descriptor type */
    USB_DESCRIPTOR_SUBTYPE_VIDEO_VC_INPUT_TERMINAL,    /* VC_INPUT_TERMINAL, descriptor subtype */
    USB_VIDEO_UVC_CAMERA_VC_INPUT_TERMINAL_ID,     /* A non-zero constant that uniquely identifies the
                                                          Terminal within the video function. This value is used
                                                          in all requests to address this Terminal. */
    USB_SHORT_GET_LOW(USB_VIDEO_UVC_CAMERA_VC_INPUT_TERMINAL_TYPE),
    USB_SHORT_GET_HIGH(USB_VIDEO_UVC_CAMERA_VC_INPUT_TERMINAL_TYPE),
    ...
    USB_VIDEO_UVC_CAMERA_VC_OUTPUT_TERMINAL_LENGTH, /* Size of this descriptor, 9+n */
    USB_DESCRIPTOR_TYPE_VIDEO_CS_INTERFACE,             /* CS_INTERFACE, descriptor type */
    USB_DESCRIPTOR_SUBTYPE_VIDEO_VC_OUTPUT_TERMINAL,    /* VC_OUTPUT_TERMINAL, descriptor subtype */
    USB_VIDEO_UVC_CAMERA_VC_OUTPUT_TERMINAL_ID,     /* A non-zero constant that uniquely identifies the
    ...
    USB_VIDEO_UVC_CAMERA_VC_INPUT_TERMINAL_ID, /* ID of the Unit or Terminal to which this Terminal is
                                                      connected */
    0x00U,                                         /* Index of a string descriptor */

    /* Processing Unit Descriptor */
    USB_VIDEO_UVC_CAMERA_VC_PROCESSING_UNIT_LENGTH, /* Size of this descriptor, 10+n */
    USB_DESCRIPTOR_TYPE_VIDEO_CS_INTERFACE,             /* CS_INTERFACE, descriptor type */
    USB_DESCRIPTOR_SUBTYPE_VIDEO_VC_PROCESSING_UNIT,    /* VC_PROCESSING_UNIT, descriptor subtype */
    USB_VIDEO_UVC_CAMERA_VC_PROCESSING_UNIT_ID,     /* A non-zero constant that uniquely identifies the
                                                           Terminal within the video function. This value is
                                                           used in all requests to address this Terminal. */
    USB_VIDEO_UVC_CAMERA_VC_INPUT_TERMINAL_ID,      /* ID of the Unit or Terminal to which this Terminal is
                                                           connected */
    ...
    USB_VIDEO_UVC_CAMERA_CONTROL_ENDPOINT |
    ...
    USB_DESCRIPTOR_LENGTH_INTERFACE,                 /* Size of this descriptor */
    USB_DESCRIPTOR_TYPE_INTERFACE,                   /* INTERFACE Descriptor */
    USB_VIDEO_UVC_CAMERA_STREAM_INTERFACE_INDEX, /* Index of stream interface */
    USB_VIDEO_UVC_CAMERA_STREAM_INTERFACE_ALTERNATE_0, /* Index of the interface setting */
    ...
    USB_VIDEO_UVC_CAMERA_VS_INTERFACE_HEADER_LENGTH, /* Size of this descriptor, in bytes: 13+(p*n) */
    USB_DESCRIPTOR_TYPE_VIDEO_CS_INTERFACE,              /* CS_INTERFACE descriptor type */
    USB_DESCRIPTOR_SUBTYPE_VIDEO_VS_INPUT_HEADER,        /* VS_INPUT_HEADER descriptor subtype */
    USB_VIDEO_UVC_CAMERA_FORMAT_COUNT,               /* One format (p = 1U)*/
    USB_SHORT_GET_LOW(USB_VIDEO_UVC_CAMERA_VS_INTERFACE_TOTAL_LENGTH),
    USB_SHORT_GET_HIGH(USB_VIDEO_UVC_CAMERA_VS_INTERFACE_TOTAL_LENGTH),
    ...
    USB_VIDEO_UVC_CAMERA_STREAM_ENDPOINT_IN | (USB_IN << 0x07U),
    /* The address of the isochronous or bulk endpoint used for video data */
    0x00U,                                                /* Dynamic Format Change unsupported */
    USB_VIDEO_UVC_CAMERA_VC_OUTPUT_TERMINAL_ID,       /* The terminal ID of the Output Terminal to which the
                                                             video endpoint of this interface is connected */
    USB_VIDEO_UVC_CAMERA_STREAM_STILL_CAPTURE_METHOD, /* Method 2U, still image capture supported */
    USB_VIDEO_UVC_CAMERA_STREAM_STILL_CAPTURE_TRIGGER_SUPPOTED,
    ...
    USB_DESCRIPTOR_TYPE_VIDEO_CS_INTERFACE,       /* CS_INTERFACE descriptor type */
	USB_DESCRIPTOR_SUBTYPE_VIDEO_VS_FORMAT_UNCOMPRESSED, /* VS_FORMAT_MJPEG descriptor subtype */
    USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FORMAT_INDEX,  /* Index of this Format Descriptor */
    USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_COUNT,   /* Number of Frame Descriptors following that correspond to
                                                     this format */

#if (USB_IMAGE_TYPE_BGR888 == 1)
	// GUID RGB24: E436EB7D-524F-11CE-9F53-0020AF0BA770
	0x7D, 0xEB, 0x36, 0xE4,
	0x4F, 0x52,
	0xCE, 0x11,
	0x9F, 0x53,
	...
	// This USB driver also supports UYVY data.
	// Down side: UYVY data is converted by the PC UVC driver. This UVC driver
	// doesn't accurately reflect the pixel values. If this is not important to
	// the application it might be worth using, because it uses only 16 bbp
	// instead of 24 bpp.
	//
	// See: https://learn.microsoft.com/en-us/windows/win32/medfound/recommended-8-bit-yuv-formats-for-video-rendering
	//
	// Note: Also update USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_DATA_BITS
	//       Use the convertTo...Uyvy(..., usb) function in main.
	//
	// GUID UYVY 59565955-0000-0010-8000-00AA00389B71
    'U','Y','V','Y',
    0x00,0x00,
    0x10,0x00,
    0x80,0x00,
	...
	USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_DATA_BITS * 8U, /* Number of bits per pixel used to specify color in the decoded video frame */
    ...
    USB_DESCRIPTOR_TYPE_VIDEO_CS_INTERFACE,      /* CS_INTERFACE descriptor type */
	USB_DESCRIPTOR_SUBTYPE_VIDEO_VS_FRAME_UNCOMPRESSED, /* VS_FRAME_MJPEG descriptor subtype */
    USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_INDEX,  /* First frame */
    0x00U,                                       /* D0, Only for still capture method 1U
                                                   D1, Fixed frame-rate */
    USB_SHORT_GET_LOW(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_WIDTH),
    USB_SHORT_GET_HIGH(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_WIDTH),
    /* Width */
    USB_SHORT_GET_LOW(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_HEIGHT),
    USB_SHORT_GET_HIGH(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_HEIGHT),
    /* HCONNECTED_EIGHT */
    USB_LONG_GET_BYTE0(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_MIN_BIT_RATE),
    USB_LONG_GET_BYTE1(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_MIN_BIT_RATE),
    USB_LONG_GET_BYTE2(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_MIN_BIT_RATE),
    USB_LONG_GET_BYTE3(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_MIN_BIT_RATE),
    /* Min bit Rate */
    USB_LONG_GET_BYTE0(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_MAX_BIT_RATE),
    USB_LONG_GET_BYTE1(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_MAX_BIT_RATE),
    USB_LONG_GET_BYTE2(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_MAX_BIT_RATE),
    USB_LONG_GET_BYTE3(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_MAX_BIT_RATE),
    /* Max bit Rate */
    USB_LONG_GET_BYTE0(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_MAX_FRAME_SIZE),
    USB_LONG_GET_BYTE1(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_MAX_FRAME_SIZE),
    USB_LONG_GET_BYTE2(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_MAX_FRAME_SIZE),
    USB_LONG_GET_BYTE3(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_MAX_FRAME_SIZE),
    /* Max Frame buffer size */
    USB_LONG_GET_BYTE0(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_DEFAULT_INTERVAL),
    USB_LONG_GET_BYTE1(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_DEFAULT_INTERVAL),
    USB_LONG_GET_BYTE2(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_DEFAULT_INTERVAL),
    USB_LONG_GET_BYTE3(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_DEFAULT_INTERVAL),
    /* Default Frame interval */
    USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_TYPE, /* frame interval type */
    USB_LONG_GET_BYTE0(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_30FPS),
    USB_LONG_GET_BYTE1(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_30FPS),
    USB_LONG_GET_BYTE2(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_30FPS),
    USB_LONG_GET_BYTE3(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_30FPS),
    /* 30fps */
    USB_LONG_GET_BYTE0(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_25FPS),
    USB_LONG_GET_BYTE1(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_25FPS),
    USB_LONG_GET_BYTE2(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_25FPS),
    USB_LONG_GET_BYTE3(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_25FPS),
    /* 25fps */
    USB_LONG_GET_BYTE0(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_15FPS),
    USB_LONG_GET_BYTE1(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_15FPS),
    USB_LONG_GET_BYTE2(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_15FPS),
    USB_LONG_GET_BYTE3(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_15FPS),
    /* 15fps */
    USB_LONG_GET_BYTE0(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_14FPS),
    USB_LONG_GET_BYTE1(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_14FPS),
    USB_LONG_GET_BYTE2(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_14FPS),
    USB_LONG_GET_BYTE3(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_14FPS),
    /* 14fps */
    USB_LONG_GET_BYTE0(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_1FPS),
    USB_LONG_GET_BYTE1(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_1FPS),
    USB_LONG_GET_BYTE2(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_1FPS),
    USB_LONG_GET_BYTE3(USB_VIDEO_UVC_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_1FPS),
    /* 1fps */
    ...
    USB_DESCRIPTOR_TYPE_INTERFACE,                   /* INTERFACE Descriptor */
    USB_VIDEO_UVC_CAMERA_STREAM_INTERFACE_INDEX, /* Index of stream interface */
    USB_VIDEO_UVC_CAMERA_STREAM_INTERFACE_ALTERNATE_1, /* Index of the interface setting */
    USB_VIDEO_UVC_CAMERA_STREAM_ENDPOINT_COUNT,  /* One endpoint of stream pipe */
    USB_DEVICE_VIDEO_CC_VIDEO,                       /* CC_VIDEO */
    USB_DEVICE_VIDEO_SC_VIDEOSTREAMING,              /* SC_VIDEOSTREAMING */
    USB_DEVICE_VIDEO_UVC_CAMERA_PROTOCOL,        /* Protocol */
    0x00U,                                           /* Index of this string descriptor */
...
{
    if (USB_VIDEO_UVC_CAMERA_CONFIGURE_INDEX > configurationDescriptor->configuration)
    {
...
usb_status_t USB_DeviceSetSpeed(usb_device_handle handle, uint8_t speed)
{
    ...
    while (descriptorHead < descriptorTail)
    {
        if (descriptorHead->common.bDescriptorType == USB_DESCRIPTOR_TYPE_ENDPOINT)
        {
            ...
            {
                if ((USB_VIDEO_UVC_CAMERA_STREAM_ENDPOINT_IN ==
